...
./db_bench ./sdfs.json -sdfs --env_uri localost:123 --benchmarks="fillseq,overwrite,filluniquerandom,readrandom,readwhilewriting,updaterandom" --num=200000 --compression_type=none
#r  ./sdfs.json -sdfs --env_uri localost:123 --benchmarks="fillseq,overwrite,filluniquerandom,readrandom,readwhilewriting,updaterandom" --num=600000 --compression_type=none
# ./db_bench ./sdfs.json -sdfs --env_uri localost:123 --benchmarks="updaterandom" --num=600000 --compression_type=none
